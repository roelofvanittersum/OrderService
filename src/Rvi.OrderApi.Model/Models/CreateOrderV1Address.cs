...
using Rvi.OrderAPI.Model.Converters;
        ...
        { 
            /// <summary>
                ...
                /// </summary>
            [DataContract]
            public class CreateOrderV1Address : IEquatable<CreateOrderV1Address>
            {
                /// <summary>
                    /// Street address
                    /// </summary>
            ...
            sb.Append("class CreateOrderV1Address {\n");
            ...
            return obj.GetType() == GetType() && Equals((CreateOrderV1Address)obj);
            }

            /// <summary>
                /// Returns true if CreateOrderV1Address instances are equal
                /// </summary>
            /// <param name="other">Instance of CreateOrderV1Address to be compared</param>
            /// <returns>Boolean</returns>
            public bool Equals(CreateOrderV1Address other)
            {
            ...
            public static bool operator ==(CreateOrderV1Address left, CreateOrderV1Address right)
            {
