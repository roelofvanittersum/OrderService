...
using Rvi.OrderAPI.Model.Converters;
        ...
        { 
            /// <summary>
                ...
                /// </summary>
            [DataContract]
            public class CreateOrderV1 : IEquatable<CreateOrderV1>
            {
                /// <summary>
                ...
                [DataMember(Name="customerDetails")]
                    public CreateOrderV1CustomerDetails CustomerDetails { get => CustomerDetailsValue; set { CustomerDetailsValue = value; CustomerDetailsIsSet = true; } }
                    private CreateOrderV1CustomerDetails CustomerDetailsValue;
                ...
                [DataMember(Name="address")]
                    public CreateOrderV1Address Address { get => AddressValue; set { AddressValue = value; AddressIsSet = true; } }
                    private CreateOrderV1Address AddressValue;
                ...
                [DataMember(Name="bankAccountDetails")]
                    public CreateOrderV1BankAccountDetails BankAccountDetails { get => BankAccountDetailsValue; set { BankAccountDetailsValue = value; BankAccountDetailsIsSet = true; } }
                    private CreateOrderV1BankAccountDetails BankAccountDetailsValue;
            ...
            return obj.GetType() == GetType() && Equals((CreateOrderV1)obj);
            }

            /// <summary>
                /// Returns true if CreateOrderV1 instances are equal
                /// </summary>
            /// <param name="other">Instance of CreateOrderV1 to be compared</param>
            /// <returns>Boolean</returns>
            public bool Equals(CreateOrderV1 other)
            {
            ...
            public static bool operator ==(CreateOrderV1 left, CreateOrderV1 right)
            {
