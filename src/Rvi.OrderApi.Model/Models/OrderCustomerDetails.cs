...
using Rvi.OrderAPI.Model.Converters;
        ...
        { 
            /// <summary>
                ...
                /// </summary>
            [DataContract]
            public class OrderCustomerDetails : IEquatable<OrderCustomerDetails>
            {
                /// <summary>
            ...
            sb.Append("class OrderCustomerDetails {\n");
            ...
            return obj.GetType() == GetType() && Equals((OrderCustomerDetails)obj);
            }

            /// <summary>
                /// Returns true if OrderCustomerDetails instances are equal
                /// </summary>
            /// <param name="other">Instance of OrderCustomerDetails to be compared</param>
            /// <returns>Boolean</returns>
            public bool Equals(OrderCustomerDetails other)
            {
            ...
            public static bool operator ==(OrderCustomerDetails left, OrderCustomerDetails right)
            {
