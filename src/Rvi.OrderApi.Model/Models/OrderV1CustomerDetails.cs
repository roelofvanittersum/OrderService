...
using Rvi.OrderAPI.Model.Converters;
        ...
        { 
            /// <summary>
                ...
                /// </summary>
            [DataContract]
            public class OrderV1CustomerDetails : IEquatable<OrderV1CustomerDetails>
            {
                /// <summary>
            ...
            sb.Append("class OrderV1CustomerDetails {\n");
            ...
            return obj.GetType() == GetType() && Equals((OrderV1CustomerDetails)obj);
            }

            /// <summary>
                /// Returns true if OrderV1CustomerDetails instances are equal
                /// </summary>
            /// <param name="other">Instance of OrderV1CustomerDetails to be compared</param>
            /// <returns>Boolean</returns>
            public bool Equals(OrderV1CustomerDetails other)
            {
            ...
            public static bool operator ==(OrderV1CustomerDetails left, OrderV1CustomerDetails right)
            {
